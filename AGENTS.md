# oh-my-clanker — repo guide for agents

One file for every harness: Codex and OpenCode read `AGENTS.md` natively;
`CLAUDE.md` is a symlink to this file for Claude Code. Deeper truth map:
